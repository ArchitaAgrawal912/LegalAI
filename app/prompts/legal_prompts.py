...
SCHEMA FOR EACH OBJECT:
{
  ...
  "ipc_bns_applied": "Identify specific IPC sections, BNS sections, or Acts mentioned. If none are found in the snippet, write 'Not explicitly mentioned in the provided text'."
}
